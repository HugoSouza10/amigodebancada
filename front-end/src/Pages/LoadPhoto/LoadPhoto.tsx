            ...
            <div className="min-h-screen min-w-screen flex items-center justify-center bg-gradient-to-r from-gray-300 via-gray-100 to-gray-300">
                <div className="flex lg:w-1/3 xl:w-1/3 2xl:w-1/3 md:w-1/2  flex-col shadow-xl">
                    ...
                    <div className="flex flex-col py-6 px-8 space-y-5 bg-white">
                        <h2 className="text-black text-center text-xs uppercase">Precisamos carregar sua foto, ok? 🤳</h2>

                        <div className="flex items-center justify-center">
                            <figure className='mr-2'>
                                <img width={70} height={70} src={iconUserMan} alt="" />
                            </figure>
                            <h2>Clique para carregar uma foto.</h2>
                        </div>
                        

                        <button type='button' className='flex break-inside bg-black rounded-full px-8 py-4 mb-4 w-full bg-gradient-to-tr from-orange-500 to-red-600 dark:text-white'>
