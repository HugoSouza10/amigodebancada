           ...
           <div className="min-h-screen min-w-screen flex items-center justify-center bg-gradient-to-r from-gray-300 via-gray-100 to-gray-300">
            <div className="flex flex-col shadow-xl">
                ...
                <div className="flex flex-col py-6 px-8 space-y-5 bg-white">
                    <h2 className="text-black text-center text-xs uppercase">Agora digite sua senha 😀</h2>
                    <label>Senha: 🔒</label>
                    ...
                    <button  className="w-full py-3 bg-gradient-to-tr from-orange-500 to-red-600 text-white rounded-full text-sm focus:outline-none focus:border-transparent shadow-lg">Cadastrar </button>
                </div>
            </div>
        </div>  
